...
function Card({ active, data }) {
  ...
  return (
    <div className="card-wrapper">
      <figure className={'bg-white rounded-3xl py-22 px-15 space-y-15 xl:px-10 sm:w-5/6 sm:mx-auto card hover:-translate-y-2 duration-200'}>
        {/* image box */}
      ...
      <div className={active ? "card-bg card-bg--active" : "card-bg" }></div>
    </div>
  );
}
