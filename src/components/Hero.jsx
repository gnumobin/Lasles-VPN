...
function Hero() {
  return <section className='container flex gap-8 justify-between lg:flex-col-reverse lg:items-center'>
    ...
    <div className='w-1/2 lg:w-full lg:text-center'>
        ...
        <h1 className='leading-24 text-7xl my-6 mb-10 font-bold text-black md:text-5xl md:leading-20'>Want anything to be <br /> easy with <strong className='font-extrabold'>LaslesVPN</strong>.</h1>
        <p className='leading-11 mb-20 text-2xl md:text-[1.4rem] lg:w-3/4 mx-auto'>Provide a network for all your needs with ease and fun using <strong>LaslesVPN</strong> discover interesting features from us.</p>
